...
class FullyConnected:
    ...
    def forward(self, inputs):
        ...
        #print("Foward pass output size",self.cache['z1'].size())
        return outputs
    ...
    def backward(self, inputs, labels, outputs):
        ...
        d1 = (torch.mm(d2,self.weights['w2'])*loss.delta_sigmoid(self.cache['z1'])#d1 (torch.tensor): error at hidden layer 1. Size like a1 (or z1)
